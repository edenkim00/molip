...
export function CreateChallengeComponent({onClose}: {onClose: () => void}) {
    ...
    return (
        <View className="w-5/6 relative flex-col">
            <LinearGradient
                colors={['#8BC6A3', '#D8EBDD']}
                className="px-6 py-4 rounded-lg w-full shadow-2xl relative">
